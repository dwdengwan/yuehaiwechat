                      ...
                      <div class="yh-father" v-for="(item,i) in stopData" :key='i' @click="details(item)">
                        <div class="yh-left">
                          <div class="yh-left-top">
                            <span class="yh-left-title">{{item.title | dealUser}}</span>
                          </div>
  ...
  methods: {
    ...
    getArrList2() {
      ...
      _this.$api.fetch({
        ...
        _this.newproMap = res.provinceMap;
    ...
    getBindData() {
      ...
      _this.$api.fetch({
        ...
        // let keyArrName = [];
        // let proArrName = [];
        // for (let key in _this.newCityMap) {
        //   keyArr.push(key)
        //   keyArrName.push(_this.newCityMap[key])
        // }
        // for (let key in _this.newproMap) {
        //   proArrName.push(_this.newproMap[key])
        // }
        // console.log(proArrName[0]+keyArrName[0]);
        // _this.groupName = proArrName[0]+keyArrName[0]
        ...
        if (bindData[0]) {
          ...
          // _this.first_sel = _this.newCityMap
          let keyArr = [];
          let keyArrName = [];
          let proArrName = [];
          for (let key in _this.newCityMap) {
