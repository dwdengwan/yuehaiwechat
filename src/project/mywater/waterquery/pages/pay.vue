  ...
  methods: {
    ...
    init() {
      ...
      this.$api.fetch({
        ...
        // alert('146pay' + localStorage.getItem('groupOpenId'))
    ...
    comfirm(i) {
      if (i == 0) {
        ...
        // Toast.success('充值成功！')
        // alert('pay267'+localStorage.getItem('groupOpenId'));
        this.$api.fetch({
          params,//参数
